<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminedit.aspx.cs" Inherits="WebApplication5.adminedit" %>
...
<body style="width: 1446px; height: 345px">
     <div style="background-color:#190940;color:whitesmoke;" class="title" >
            <strong><span class="auto-style6">Edit Trip</span></strong>
  ...
  <div class="row">
    ...
    <div class="col-75">
      <asp:TextBox ID="txtID" runat="server"  ReadOnly="true" disabled></asp:TextBox>
    </div>
  </div>
  ...
  <div class="row">
    ...
    <div class="col-75">
     <asp:TextBox ID="TextBoxPassengers_Count" runat="server"></asp:TextBox>
        ...
        <asp:CustomValidator ID="CustomValidator1" runat="server" ControlToValidate="TextBoxPrice" Display="Dynamic" ErrorMessage="Can't set Number of Passengers Below Reservations" ForeColor="Red" OnServerValidate="CustomValidator1_ServerValidate1"></asp:CustomValidator>
    </div>
      </div>
               <strong>
        <asp:Button ID="Button1" runat="server" Text="Edit"  CssClass="auto-style3" OnClick="Button1_Click" />
               </strong>
