...
<body>
    <form id="form1" runat="server" >
        <div style="background-color:#190940;color:whitesmoke;" class="title auto-style7" >
          ...
          <br />
        <div class="title auto-style7" style="color:#190940;">
            <strong><span class="auto-style6">Admin Dashboard</span></strong>
        </div>
        ...
        <asp:Button ID="Button1" runat="server" Text="Add" OnClick="Button1_Click" CssClass="auto-style8" />
